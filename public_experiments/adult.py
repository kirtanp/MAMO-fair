...
def adult_multi_fairness(fairness_notion='ddp'):
    ...
    if(fairness_notion == 'both'):
        ...
        print('The deo has mean ', 1-np.mean(scores_mo_adult[:,[2]]),              ' and standard deviation ', np.std(scores_mo_adult[:,[2]]))
    else:        
        print('The error has mean ', 1-np.mean(scores_mo_adult[:,[0]]),              ' and standard deviation ', np.std(scores_mo_adult[:,[0]]))
        print('The fairness has mean ', 1-np.mean(scores_mo_adult[:,[1]]),              ' and standard deviation ', np.std(scores_mo_adult[:,[1]]))
